...
# Zero-width space/joiners and BOM: invisible characters that sometimes leak
# in from copy-pasted or scraped text and would otherwise corrupt dedup hashing.
